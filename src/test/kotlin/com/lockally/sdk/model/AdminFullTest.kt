...
class AdminFullTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of AdminFull
        //val modelInstance = AdminFull()
        ...
        // to test the property `password` - Present ONLY on POST response when lockally generated the password. Shown once.
